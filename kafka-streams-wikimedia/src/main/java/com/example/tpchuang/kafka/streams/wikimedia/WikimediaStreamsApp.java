package com.example.tpchuang.kafka.streams.wikimedia;

import com.example.tpchuang.kafka.streams.wikimedia.processor.BotCountStreamBuilder;
import com.example.tpchuang.kafka.streams.wikimedia.processor.EventCountTimeseriesBuilder;
import com.example.tpchuang.kafka.streams.wikimedia.processor.WebsiteCountStreamBuilder;
...
public class WikimediaStreamsApp {
  ...
  private static final String INPUT_TOPIC = "wikimedia_changes";
